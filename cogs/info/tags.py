...
class Tags(commands.Cog):
    ...
    async def tags(self, ctx: AluGuildContext, *, tag_name: str):
        """Execute tag from the database"""
        await self.tag_work(ctx, tag_name.lower())

    @tags.error
    async def tags_error(self, ctx: AluGuildContext, error):
    ...
    async def info(self, ctx: AluGuildContext, *, tag_name: str):
    ...
    @app_commands.describe(tag_name="Tag name")
    async def delete(self, ctx: AluGuildContext, *, tag_name: str):
    ...
    async def modtags(self, ctx: AluGuildContext):
    ...
    async def ban(self, ctx: AluGuildContext, member: discord.Member):
