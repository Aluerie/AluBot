...
from utils.var import Cid, Clr, Ems, Rid, Sid, Uid, cmntn, rmntn, umntn
...
def get_a_text():
    daily_reminders_txt = [
        ...
        f'don\'t hesitate to ping {umntn(Uid.irene)} about it pretty please !',
    ...
    return daily_reminders_txt[db.inc_value(db.g, Sid.irene, 'current_timer') % len(daily_reminders_txt)]
...
def get_important_text():
    ...
    return daily_reminders_txt[db.inc_value(db.g, Sid.irene, 'current_important_timer') % len(daily_reminders_txt)]
...
def get_fact_text():
    ...
    return daily_reminders_txt[db.inc_value(db.g, Sid.irene, 'current_fact_timer') % len(daily_reminders_txt)]
...
def get_gif_text():
    ...
    return daily_reminders_txt[db.inc_value(db.g, Sid.irene, 'current_gif_timer') % len(daily_reminders_txt)]
