...
Note that oracle code snippets are commented out
"""
...
from sqlalchemy import (
    Column, Integer, Boolean, String, Float, BigInteger, DateTime, PickleType
)
from sqlalchemy import create_engine
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import sessionmaker

from config import NON_ASYNC_SQLALCHEMY_PG_URL

engine = create_engine(NON_ASYNC_SQLALCHEMY_PG_URL, echo=False, )  # connect to database,  echo = true to debug
