...
if TYPE_CHECKING:
    MaterialShadeLiteral = Literal[900, 800, 700, 600, 500, 400, 300, 200, 100, 50]
...
def material_worker(colour_hexes: list[int], shade: MaterialShadeLiteral) -> discord.Colour:
...
class MaterialPalette:
    ...
    @staticmethod
    def red(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def pink(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def purple(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def deep_purple(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def indigo(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def blue(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def light_blue(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def cyan(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def teal(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def green(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def light_green(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def lime(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def yellow(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def amber(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def orange(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def deep_orange(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def brown(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def gray(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def blue_gray(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def black(shade: MaterialShadeLiteral = 500) -> discord.Colour:
    ...
    @staticmethod
    def white(shade: MaterialShadeLiteral = 500) -> discord.Colour:
...
def accent_worker(colour_hexes: list[int], shade: MaterialShadeLiteral) -> discord.Colour:
