...
class Accent:
    ...
    def deep_orange(shade: Literal[700, 400, 200, 100] = 200) -> discord.Colour:
        ...
        shades = {700: 0xDD2C00, 400: 0xFF3D00, 200: 0xFF6E40, 100: 0xFF9E80}
        return discord.Colour(shades[shade])
