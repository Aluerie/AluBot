...
class Palette(discord.Colour):

    shades: List[int]

    @classmethod
    def get_colour(cls, colour_list: List[int], shade: int) -> Self:
...
class MaterialAccentPalette(Palette):
    ...
    @classmethod
    def red(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xD50000, 0xFF1744, 0xFF5252, 0xFF8A80]
        return cls.get_colour(c, shade)

    @classmethod
    def pink(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xC51162, 0xF50057, 0xFF4081, 0xFF80AB]
        return cls.get_colour(c, shade)

    @classmethod
    def purple(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xAA00FF, 0xD500F9, 0xE040FB, 0xEA80FC]
        return cls.get_colour(c, shade)

    @classmethod
    def deep_purple(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x6200EA, 0x651FFF, 0x7C4DFF, 0xB388FF]
        return cls.get_colour(c, shade)

    @classmethod
    def indigo(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x304FFE, 0x3D5AFE, 0x536DFE, 0x8C9EFF]
        return cls.get_colour(c, shade)

    @classmethod
    def blue(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x2962FF, 0x2979FF, 0x448AFF, 0x82B1FF]
        return cls.get_colour(c, shade)

    @classmethod
    def light_blue(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x0091EA, 0x00B0FF, 0x40C4FF, 0x80D8FF]
        return cls.get_colour(c, shade)

    @classmethod
    def cyan(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x00B8D4, 0x00E5FF, 0x18FFFF, 0x84FFFF]
        return cls.get_colour(c, shade)

    @classmethod
    def teal(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x00BFA5, 0x1DE9B6, 0x64FFDA, 0xA7FFEB]
        return cls.get_colour(c, shade)

    @classmethod
    def green(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x00C853, 0x00E676, 0x69F0AE, 0xB9F6CA]
        return cls.get_colour(c, shade)

    @classmethod
    def light_green(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0x64DD17, 0x76FF03, 0xB2FF59, 0xCCFF90]
        return cls.get_colour(c, shade)

    @classmethod
    def lime(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xAEEA00, 0xC6FF00, 0xEEFF41, 0xF4FF81]
        return cls.get_colour(c, shade)

    @classmethod
    def yellow(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xFFD600, 0xFFEA00, 0xFFFF00, 0xFFFF8D]
        return cls.get_colour(c, shade)

    @classmethod
    def amber(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xFFAB00, 0xFFC400, 0xFFD740, 0xFFE57F]
        return cls.get_colour(c, shade)

    @classmethod
    def orange(cls, shade: AccentShadeLiteral = 200) -> Self:
        c = [0xFF6D00, 0xFF9100, 0xFFAB40, 0xFFD180]
        return cls.get_colour(c, shade)

    @classmethod
    def deep_orange(cls, shade: AccentShadeLiteral = 200) -> Self:
...
if __name__ == '__main__':
    ...
    rectangle = Image.new("RGB", (600, 300), str(MaterialPalette.purple()))
    rectangle.show()
