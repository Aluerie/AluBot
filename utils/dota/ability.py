        ...
        for hero_ability in hero_abilities.values():
            ...
            for ability_name in hero_ability["abilities"]:
                ...
                if img_url:
                    ...
                    data["icon_by_id"][ability_id] = DOTA.HERO_DISCONNECT
...
async def icon_by_id(value: int) -> str:
    ...
    return await ability_keys_cache.get("icon_by_id", value, DOTA.HERO_DISCONNECT)


async def talent_by_id(value: int) -> str:
    ...
    """
    return await ability_keys_cache.get_value_or_none("talent_by_id", value)
